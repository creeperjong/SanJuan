...
void table(sPlayer* player, int32_t num_of_player){
    ...
    printf("║　　　　　　　　　　　　　　　　　　　　　　　　　║　　　　　　　　　　　　　　　　　　　　　　　　　║\n");
    printf("║　%s　%s　%s　%s　║　%s　%s　%s　%s　║\n", CARD(1, 5), CARD(1, 6), CARD(1, 7), CARD(1, 8), CARD(2, 5), CARD(2, 6), CARD(2, 7), CARD(2, 8));
    ...
    printf("║　　　　　　　　　　　　　　　　　　　　　　　　　║　　　　　　　　　　　　　　　　　　　　　　　　　║\n");
    printf("╠══════════════════════════════════════════════════╬══════════════════════════════════════════════════╣\n");
    printf("║ＰＬＡＹＥＲ０３　　　　　　　　　　ＶＰｓ： %03d　║ＰＬＡＹＥＲ０４　　　　　　　　　　ＶＰｓ： %03d　║\n", (num_of_player >= 3) ? player[2].vp : 0, (num_of_player >= 4) ? player[3].vp : 0);
    printf("║　　　　　　　　　　　　　　　　　　　　　　　　　║　　　　　　　　　　　　　　　　　　　　　　　　　║\n");
    ...
    printf("║　　　　　　　　　　　　　　　　　　　　　　　　　║　　　　　　　　　　　　　　　　　　　　　　　　　║\n");
    printf("║　%s　%s　%s　%s　║　%s　%s　%s　%s　║\n", CARD(3, 5), CARD(3, 6), CARD(3, 7), CARD(3, 8), CARD(4, 5), CARD(4, 6), CARD(4, 7), CARD(4, 8));
